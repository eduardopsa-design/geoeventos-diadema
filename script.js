console.log("GeoDiadema 3.0 carregado");
...
const vivaleiteDaysInput=document.getElementById("vivaleiteDaysInput");
...
function fillVivaleiteForm(item){
 ...
 vivaleiteDaysInput.value=item.diasEntrega||"";
...
function getVivaleiteMissing(){
 ...
 if(!vivaleiteDaysInput.value.trim())missing.push("dias de entrega");
...
function updateVivaleiteQuality(){
 const vals=[
  ...
  vivaleiteDaysInput.value.trim(),vivaleiteStartInput.value,
...
function getVivaleitePayload(){
 return{
  ...
  diasEntrega:vivaleiteDaysInput.value.trim(),
...
[
 vivaleiteNameInput,vivaleiteStatusInput,vivaleiteDaysInput,
