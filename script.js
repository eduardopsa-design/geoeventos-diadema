console.log("GeoDiadema 2.3 carregado");
...
function getGabinetePdfFilename() {
  ...
  return `Agenda Executiva - ${location} - ${formatFilenameDate(selectedDate)}.pdf`;
}
  ...
  gabinetePreviewDocument.innerHTML = `
    ...
    <section class="briefing-summary-section">
      ...
      <ul class="briefing-summary-list">
        <li><span>Eventos</span><strong>${eventCount}</strong></li>
        <li><span>Hortas</span><strong>${hortaCount}</strong></li>
