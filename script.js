console.log("GeoDiadema 3.2.1 carregado");
...
function updateVivaleiteInternalDashboard(){
 ...
 vlChildrenTotal.textContent=sum("criancas").toLocaleString("pt-BR");
 vlElderlyTotal.textContent=sum("idosos").toLocaleString("pt-BR");
 vlBeneficiariesTotal.textContent=(sum("criancas")+sum("idosos")).toLocaleString("pt-BR");
 vlCapacityTotal.textContent=sum("capacidade").toLocaleString("pt-BR");
 vlVacanciesTotal.textContent=sum("vagas").toLocaleString("pt-BR");
